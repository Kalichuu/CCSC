...
<div class="wrapper">
    ...
    <section id="banner">
        <h2> Members Login </h2>
        <p> Log in Down Below. Do not have an account? <a href="register.php" class="button special"> Register Here</a></p>
                ...
                <section class="box">
                    <form method="post">
                        ...
                        <div class="row uniform">
                            <div class="12u">
                                <ul class="actions">
                                    <li><input type="submit" namne="btn-login" value="Login" class="button fit"></li>
                                </ul>
                            </div>
                        </div>
